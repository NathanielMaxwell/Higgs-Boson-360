...
\subsection{Data}
  In our initial data set, we take a sample of 89,393 tracks from 186,000 released by Spotify that document features of the track, as well as if it was skipped or not. The tracks within the data set were not confined to any prerequisite of genre or form; perhaps some were not even songs, but rather audiobooks or podcasts. We wanted to attempt to narrow the track selection to represent only songs, and see if any variables could impact the "popularity" of a track. Because this data set was not confined to an individual “taste” nor genre, limitations of this data were that track features may not be determined as significant due to the broadness of the data collected. Given this limitation, we decided to also analyze data that pertained to one specific individual who recorded his tastes for 2,000 songs. 
  
  For this second dataset, the size was not as big because it presented the opinions of a single individual. George McIntire assembled this data when exploring possible explanations behind his varying taste in music. He created two playlists — each with 1,000 songs — one with songs he liked and the other with songs he did not like [4]. In order to minimize bias, he had to make the “BAD” playlist equally as diverse as the “GOOD” playlist by putting in songs of different form rather than an entire album of a single artist he did not like. Each song contained musical attributes that hopefully will help explain his choice of a "BAD" vs. "GOOD" song.
